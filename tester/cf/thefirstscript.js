...
var maze; // The maze array, with pills and walls
		...
		gbox.onLoad(function () {
			...
			gbox.addTiles({id:"fodder",image:"tower1",tileh:200,tilew:200,tilerow:4,gapx:0,gapy:0});
			gbox.addTiles({id:"shell",image:"tower1",tileh:200,tilew:200,tilerow:4,gapx:0,gapy:0});
